...
using NewPoint.ErrorLocalizationAPI.Services;
using NewPoint.ErrorLocalizationAPI.Middleware;
...
namespace NewPoint.ErrorLocalizationAPI;
...
public class Startup
{
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env, LocalizationLoader localizationLoader)
    {
        ...
        localizationLoader.LoadAndStoreLocalizations().Wait();
        ...
        {
            endpoints.MapGrpcService<ErrorLocalizationService>();
